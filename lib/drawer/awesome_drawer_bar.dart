...
import 'package:message/drawer/widgets/adaptive_layout_custom.dart';
import 'package:flutter/material.dart';

class DrawerClientController {
...
class DrawerClient extends StatefulWidget {
  ...
  final DrawerClientController? controller;
  ...
  @override
  _DrawerClientState createState() => new _DrawerClientState();

  /// static function to provide the drawer state
  static _DrawerClientState? of(BuildContext context) {
    return context.findAncestorStateOfType<State<DrawerClient>>() as _DrawerClientState?;
  }
}

class _DrawerClientState extends State<DrawerClient> with SingleTickerProviderStateMixin {
